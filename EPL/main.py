...
def index():
    global chosen_data_matches, display_data, matches, rand_index, teams_data,match_data_live
    ...
    if 'username' in session:
        if request.method == 'GET':
            ...
            return render_template('index.html', match_data=match_data, match_index=match_index,match_data_live=match_data_live)
    else:
...
def show_match_data(match_index):
    global chosen_data_matches, X_train1, display_data, rand_index ,team_data
    ...
    if form.validate_on_submit():
        ...
        return render_template('match_data2.html', pred=pred, dataset2_values=dataset2_values, form=form, comments=comments, match_index=match_index, players_by_team=players_by_team, display_data=chosen_data_matches, team_data=team_data)
    ...
    return render_template('match_data.html', dataset2_values=dataset2_values, form=form, comments=comments, match_index=match_index, players_by_team=players_by_team, display_data=chosen_data_matches,team_data=team_data)
