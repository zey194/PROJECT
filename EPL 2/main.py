...
def index():
    global chosen_data_matches, display_data, matches, rand_index, teams_data,match_data_live,upcoming_matches
    ...
    if 'username' in session:
        if request.method == 'GET':
            ...
            return render_template('index.html', match_data=match_data, match_index=match_index,match_data_live=match_data_live, upcoming_matches=upcoming_matches)
    else:
